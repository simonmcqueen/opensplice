...
FOR %%f IN (%TOOLSHELPERS%) DO %C_COMPILER% /wd4996 /Dsnprintf=_snprintf /nologo %VENDOR_INCLUDES% %DDS_C_INCLUDES% %GEN_INCLUDES% %OS_INCLUDES% /c "%TOOLS_DIR%\%%f.c" /Fo%OBJ_DIR%\%%f.obj
FOR %%f IN (%TOOLS%) DO %C_COMPILER% /wd4996 /Dstrcasecmp=strcmpi /Dsnprintf=_snprintf /nologo %VENDOR_INCLUDES% %DDS_C_INCLUDES% %GEN_INCLUDES% %OS_INCLUDES% /c "%TOOLS_DIR%\%%f.c" /Fo%OBJ_DIR%\%%f.obj
